...
public class ChangeHistoryDAO extends MyDAO {
    ...
    public HashMap<String, Object> compareAcc(Account acc, String adr, String name, String phone, int stt, boolean gender) {
    ...
    //main
    public void changeHistory(Account acc, String adr, String name, String phone, int stt, boolean gender, String changedBy) {
        String time = DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm:ss").format(LocalDateTime.now());
        insertHistory(compareAcc(acc, adr, name, phone, stt, gender), acc.getAccID(), changedBy, time);
    }
