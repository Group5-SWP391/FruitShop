            ...
            <div class="right-content">
                ...
                <div class="contact-container">
                    ...
                    <div class="cart-total">
                        ...
                        <button type="submit" onclick="setPaymentValue(1)" class="checkoutBtn"><span>Payment On Delivery</span></button>
                        <button style="margin-top: 2rem;" class="checkoutBtn" id="changeBtn1" onclick="setPaymentValue(2)"><span>Online Payment</span></button>
                        <input type="hidden" id="payment" name="payment" value="">
                        </form>
                        <script>
                            function setPaymentValue(data) {
                                document.getElementById("payment").value = data;
                            }
                        </script>
                    </div>
                </div>
